        ...
        <div className="about-card">
          ...
          <div className="about-paragraph">
            <p>
              ...
              software, I spent over a decade in healthcare, working everywhere
              from psychiatric facilities to hospitals. I also completed college
              prerequisites with the initial goal of pursuing a nursing degree.
              These experiences taught me how to listen, adapt, and solve real
              problems under pressure. I've seen the human side of systems and
              now I build digital ones with empathy and precision.
            </p>
          </div>
          <div className="paragraph-spacer"></div>
